...
class Documento_Latex():
    ...
    def portada(Diccionario, T_Hornilla, Area_bag, Area, Texto_Area):
        global doc
        doc = Document()
        ...
        with doc.create(MediumText(' ')) as tlg:
                    ...
                    tlg.append('\n \n') #Salto de línea en parráfo
                    #Verificar area
                    Parrafo= ('Con base en la información suministrada, HornillApp propone la construcción de una hornilla panelera tipo Cimpa con una '+
                              ...
                              '\n Está hornilla requiere un área para la(s) bagacera(s) aproximadamente de '+Area_bag+' m^2. Además, está propuesta de valor presenta una '
                              )
                    

                    tlg.append(Parrafo)                
                    Parrafo= (' versión optimizada de la hornilla que reduce el uso de combustible (bagazo, carbón o madera) al incorporar un sistema recuperador de calor. '
    ...
    def generar_pdf():  
        ...
        shutil.copy('static/Latex/A0_Cotizacion.pdf', 'static/pdf00/A0_Cotizacion.pdf')
        remove('static/Latex/A0_Cotizacion.pdf')
        remove('static/Latex/A0_Cotizacion.tex')
